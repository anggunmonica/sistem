...
<div class="container">
	...
	<div class="panel panel-container">
		<div class="bootstrap-table">
			<a href="useraksi_persediaan.php?aksi=tambah" class="btn btn-primary">Tambah User</a>
					...
					<?php
						...
						<tr>
							...
							<td class="text-center">
								<a href="useraksi_persediaan.php?kode_akun=<?php echo $a['kode_akun'] ?>&aksi=ubah" class="btn btn-success">Ubah</a>
								<a href="userproses_persediaan.php?kode_akun=<?php echo $a['kode_akun'] ?>&proses=proseshapus" class="btn btn-danger">Hapus</a>
							</td>
						</tr>
						<?php
							}
