	...
	?>
		...
		<div class="container">
			<div class="bootstrap-table">
				<form action="userproses_persediaan.php?proses=prosestambah" method="post" enctype="multipart/form-data">
					...
					<div class="modal-footer">
						<a href="user_persediaan.php" class="btn btn-primary">Kembali</a>
	...
	<?php
		...
		<div class="panel panel-container">
			<div class="bootstrap-table">
				...
				?>
					<form action="userproses_persediaan.php?proses=prosesubah" method="post" enctype="multipart/form-data">
